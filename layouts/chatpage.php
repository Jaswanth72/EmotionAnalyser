		...
		<div class="message">
			<p>
				...
				<?php if($row['message']=='I am angry')
							...
							echo 'sad';
						else if($row['message']=='I admire him a lot!' || $row['message']=='The party was a real surprise')
							echo 'surprise';
						else if($row['message']=='lion and others adore him' || $row['message']=='Lion and others adore him')
							echo 'joy';
...
<div class="message">
			<p>
				No previous text record available.
			</p>
</div>
<?php
	} 
